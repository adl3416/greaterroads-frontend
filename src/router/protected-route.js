...
const ProtectedRoute = ({children ,admin}) => { // children :<UserTemplate><ProfilePage/></UserTemplate>
     ...
     const {isUserLogin, user}= useSelector(state=> state.auth.isUserLogin);    //once kullanicinin giris yapip yapmadigini ögrenmemiz gerekiyor. Burdan bize true yada false gelir
